...
], EventUpdateDto.prototype, "id", void 0);
__decorate([
...
], EventUpdateDto.prototype, "title", void 0);
__decorate([
    express_helper_1.vendors.classValidator.IsOptional(),
    express_helper_1.vendors.classValidator.IsString(),
    express_helper_1.vendors.classValidator.Length(1)
], EventUpdateDto.prototype, "content", void 0);
__decorate([
    express_helper_1.vendors.classValidator.IsOptional(),
    express_helper_1.vendors.classValidator.IsDateString()
], EventUpdateDto.prototype, "date_of_event", void 0);
__decorate([
    express_helper_1.vendors.classValidator.IsOptional(),
    express_helper_1.vendors.classValidator.IsUUID('4')
], EventUpdateDto.prototype, "photo_id", void 0);
__decorate([
    express_helper_1.vendors.classValidator.IsOptional(),
    express_helper_1.vendors.classValidator.IsArray(),
    express_helper_1.vendors.classValidator.IsUUID('4', { each: true })
], EventUpdateDto.prototype, "attachments", void 0);
